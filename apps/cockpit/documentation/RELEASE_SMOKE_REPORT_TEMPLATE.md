...
| ------ | ---------------------------------------------------------------------- | -------- | ------- | -------- |
| PRE-01 | Cockpit CI is green for the release commit                             | Yes      | Not run |          |
| PRE-02 | All four `Build & Release Cockpit` matrix jobs passed                  | Yes      | Not run |          |
...
| PRE-06 | Runtime checks use a disposable account/VM with clean Cockpit app data | Yes      | Not run |          |
