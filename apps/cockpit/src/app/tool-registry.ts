...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    group: 'web',
    icon: toolIcon(HashStraightIcon),
    description:
      'Calculate specificity with segmented bars, component breakdown, winner detection, and !important',
  ...
  // --- Convert ---
  {
    ...
    name: 'Case Converter',
    group: 'convert',
    icon: toolIcon(TextAaIcon),
    description: 'Convert between 12 cases with detection, word splitting, and chaining',
  ...
  },
  {
    ...
    group: 'convert',
    icon: toolIcon(ClockIcon),
    description: 'Timestamps with presets, date picker, timezone, day/week info',
  ...
  // --- Test ---
  {
    ...
    name: 'Regex Tester',
    group: 'test',
    icon: toolIcon(AsteriskIcon),
    description: 'Test and replace with match highlighting, groups, and export',
  ...
  },
  {
    ...
    name: 'Docs Browser',
    group: 'network',
    icon: toolIcon(BookOpenTextIcon),
    description: 'Browse devdocs.io documentation',
