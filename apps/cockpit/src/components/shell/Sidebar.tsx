...
export function Sidebar() {
  ...
  return (
    <aside
      className={`flex shrink-0 flex-col overflow-hidden border-r border-[var(--color-border)] bg-[var(--color-surface)] shadow-[1px_0_0_0_var(--color-border),2px_0_8px_-2px_var(--color-shadow)] transition-[width] duration-200 ease-in-out ${sidebarCollapsed ? 'w-10 items-center py-2' : 'w-[218px]'}`}
    >
      {sidebarCollapsed ? (
        <>
          <button
