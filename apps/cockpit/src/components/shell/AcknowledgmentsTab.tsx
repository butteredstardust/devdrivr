  ...
  return (
    <div className="space-y-4">
      <p className="text-2xs leading-relaxed text-[var(--color-text-muted)]">
        devdrivr cockpit is MIT licensed and built on the work below. Only direct dependencies are
        named; the full text of every licence they are offered under is reproduced at the bottom of
        this tab.
      </p>
