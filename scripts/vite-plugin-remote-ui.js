 ...
 * devdrivr cannot: `@tauri-apps/plugin-sql`, `plugin-fs`, `plugin-http` and `plugin-dialog` each
 ...
 * are fine. Nothing in devdrivr uses one today.
 */
